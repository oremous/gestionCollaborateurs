...
$(function() {
    ...
    $(document).on("click",".add-btn",function () {
		var experiencecontent = '<tr class="add-row">' +
			'<td>' +
				'<input type="text" name="tache[]" required class="form-control">' +
			'</td>' +
			'<td>' +
				'<textarea class="form-control "  name="descriptiontache[]" id="" ></textarea>' +
			'</td>' +
			'<td>' +
        ...
        $(".add-table-items tbody").append(experiencecontent);
        return false;
    });
